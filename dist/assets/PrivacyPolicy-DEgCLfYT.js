import{r as a,j as e,G as n,t as l,U as d,v as g,w as f,x as c}from"./index-BZ4dgNpH.js";import{S as m}from"./shield-Dm7UB6fe.js";import{A as y}from"./alert-circle-BpdYb27a.js";import{F as b}from"./file-text-BISHpUzl.js";import{D as v}from"./database-D7EfZYli.js";import{E as w}from"./eye-ih0bdDA0.js";import{C as j}from"./clock-RLrYLks2.js";const U=()=>{const[u,o]=a.useState([]);a.useEffect(()=>{(()=>{const i=[];for(let r=0;r<30;r++)i.push({id:r,x:Math.random()*100,y:Math.random()*100,size:Math.random()*3+1,speedX:(Math.random()-.5)*.3,speedY:(Math.random()-.5)*.3});o(i)})();const x=setInterval(()=>{o(i=>i.map(r=>({...r,x:(r.x+r.speedX+100)%100,y:(r.y+r.speedY+100)%100})))},100);return()=>clearInterval(x)},[]);const p=[{icon:b,title:"Information We Collect",content:`The types of personal information we obtain about you depend on how you interact with our Site and use our Services. When we use the term "personal information", we are referring to information that identifies, relates to, describes or can be associated with you.
