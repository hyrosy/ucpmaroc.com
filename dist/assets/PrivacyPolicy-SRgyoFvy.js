import{r as a,j as e,G as n,p as l,U as d,q as g,t as f,v as c}from"./index-BRMoMsJu.js";import{S as m}from"./shield-B60Lkiq4.js";import{A as y}from"./alert-circle-95h-0-_g.js";import{F as b}from"./file-text-Cn2Htf31.js";import{D as v}from"./database-CUIEQE7U.js";import{E as j}from"./eye-DzcegnhB.js";import{C as w}from"./clock-BdC42CbF.js";const U=()=>{const[u,o]=a.useState([]);a.useEffect(()=>{(()=>{const i=[];for(let r=0;r<30;r++)i.push({id:r,x:Math.random()*100,y:Math.random()*100,size:Math.random()*3+1,speedX:(Math.random()-.5)*.3,speedY:(Math.random()-.5)*.3});o(i)})();const x=setInterval(()=>{o(i=>i.map(r=>({...r,x:(r.x+r.speedX+100)%100,y:(r.y+r.speedY+100)%100})))},100);return()=>clearInterval(x)},[]);const p=[{icon:b,title:"Information We Collect",content:`The types of personal information we obtain about you depend on how you interact with our Site and use our Services. When we use the term "personal information", we are referring to information that identifies, relates to, describes or can be associated with you.
