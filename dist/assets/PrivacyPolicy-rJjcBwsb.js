import{r as a,j as e,G as n,q as l,U as d,t as g,v as f,w as c}from"./index-B9Pdx4rw.js";import{S as m}from"./shield-BJNbMo7h.js";import{A as y}from"./alert-circle-Ctshw1NM.js";import{F as b}from"./file-text-Ci0BHJ6K.js";import{D as v}from"./database-BEAF3cMq.js";import{E as w}from"./eye-BHNEjJn1.js";import{C as j}from"./clock-DfRSbGIR.js";const U=()=>{const[u,o]=a.useState([]);a.useEffect(()=>{(()=>{const i=[];for(let r=0;r<30;r++)i.push({id:r,x:Math.random()*100,y:Math.random()*100,size:Math.random()*3+1,speedX:(Math.random()-.5)*.3,speedY:(Math.random()-.5)*.3});o(i)})();const x=setInterval(()=>{o(i=>i.map(r=>({...r,x:(r.x+r.speedX+100)%100,y:(r.y+r.speedY+100)%100})))},100);return()=>clearInterval(x)},[]);const p=[{icon:b,title:"Information We Collect",content:`The types of personal information we obtain about you depend on how you interact with our Site and use our Services. When we use the term "personal information", we are referring to information that identifies, relates to, describes or can be associated with you.
...
We treat all third-party data in accordance with this Privacy Policy.`},{icon:w,title:"How We Use Your Information",content:`We use your personal information to:
