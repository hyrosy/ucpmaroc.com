import{r as a,j as e,G as n,p as l,U as d,q as g,t as f,v as c}from"./index-DtyyT-J8.js";import{S as m}from"./shield-DNq6By34.js";import{A as y}from"./alert-circle-dD27Xd1u.js";import{F as b}from"./file-text-IWo_9zhT.js";import{D as v}from"./database-BHx42C-Z.js";import{E as j}from"./eye-DkcT394I.js";import{C as w}from"./clock-Do7zVuXy.js";const U=()=>{const[u,o]=a.useState([]);a.useEffect(()=>{(()=>{const i=[];for(let r=0;r<30;r++)i.push({id:r,x:Math.random()*100,y:Math.random()*100,size:Math.random()*3+1,speedX:(Math.random()-.5)*.3,speedY:(Math.random()-.5)*.3});o(i)})();const x=setInterval(()=>{o(i=>i.map(r=>({...r,x:(r.x+r.speedX+100)%100,y:(r.y+r.speedY+100)%100})))},100);return()=>clearInterval(x)},[]);const p=[{icon:b,title:"Information We Collect",content:`The types of personal information we obtain about you depend on how you interact with our Site and use our Services. When we use the term "personal information", we are referring to information that identifies, relates to, describes or can be associated with you.
